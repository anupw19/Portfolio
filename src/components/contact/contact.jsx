...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_1k73j3f', 'template_x12ijlb', formref.current, {
            publicKey: 'moAl1lljjJPAeaIXm',
          })
          .then(
            (result) => {
              setSuccess(true);
        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>anupwaskel77@gamil.com</span>
                </motion.div>
                    <motion.div className="item" variants={variants}>
                        <h2>Address</h2>
            ...
            <motion.div className="formContainer" variants={variants}>
                    ...
                    <svg height="450px" width="450px" viewBox="0 0 512 512"  >
                        <g>
                            <motion.path
                                ...
                                c-8.344-13.014-38.042-42.678-46.152-47.702c-8.086-5.015-21.598-0.124-28.105,9.426c-6.526,9.55-11.674,6.689-11.674,6.689s-18.516-14.957-44.124-66.621c-25.607-51.694-26.263-75.454-26.263-75.454s0.833-5.847,12.388-5.263
                                ...
                                c-9.469,8.564-24.071,14.928-45.2,14.967l-0.516,0.009C130.797,481.96,29.387,381.09,29.397,256c0.01-62.621,25.339-119.186,66.367-160.237c41.053-41.023,97.612-66.354,160.234-66.364c62.621,0.01,119.181,25.34,160.232,66.364
                ...
                >
                    <input type="text" required placeholder="Name" aria-label="Name" name="name"/>
                    <input type="email" required placeholder="Email" aria-label="Email" name="email"/>
                    <textarea rows={8} required placeholder="Message" aria-label="Message" name="message"/>
